...
public class Five extends Digit {
    ...
    private boolean arrangeWithOne = false;
    ...
    public float[] getLeftMinute(float centerX, float centerY, float strokeWidth) {
        ...
        points.add((arrangeWithOne) ? centerX - strokeWidth / 2 - space : centerX - (centerX / 2) + space);
    ...
    public float[] getRightHour(float centerX, float centerY, float strokeWidth) {
        ...
        points.add(lineX4 + strokeWidth + space);
    ...
    public void setArrangeWithOne(boolean arrangeWithOne) {
        this.arrangeWithOne = arrangeWithOne;
    }
}
